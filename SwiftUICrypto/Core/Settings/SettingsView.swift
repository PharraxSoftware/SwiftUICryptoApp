...
struct SettingsView: View {
    ...
    let youtubeURL = URL(string: "https://www.youtube.com/c/swiftulthingking")!
    ...
    private var swiftuIthinkingSection: some View {
        Section(header: Text("SwiftuI Thinking")) {
            VStack(alignment: .leading) {
                ...
                Text("This app was made by following a @SwiftuIThinking on YouTube. It uses MVVM Architecture, Combine, and CoreData!")
                    .font(.callout)
                    .fontWeight(.medium)
